...
public class Controller implements Initializable {
    ...
    private void aboutClicked(ActionEvent e) {
        ...
        alert.setContentText("Anas Ghamri\n"
        		+ "Zakaria Mestaoui\n"
        		+ "4eme année genie informatique\n"
        		+ "Ensa Marrakech\n"
        		+ "Encadré par M. Nejeoui.\n");
        alert.showAndWait();
    }
    ...
    private void startClicked(ActionEvent e)
    {
        ...
        if(video.getFrame().getConvertisseursCoordonnees().size()>=1 ) {
            ...
            alert.setTitle("Manque de reference !!");
            alert.setContentText("Ajouter au moins un rectangle de reperage et respectez l'ordre afin d'obtenir des resultats corrects !");
